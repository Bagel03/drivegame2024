...
var init_dist = __esm({
    "node_modules/.pnpm/@capacitor+core@5.6.0/node_modules/@capacitor/core/dist/index.js"() {
        ...
        CapacitorPlatforms = /* @__PURE__ */ initPlatforms(
                    ...
                    if (!jsImplementation && platform in jsImplementations) {
                        jsImplementation =
                            typeof jsImplementations[platform] === "function"
                                ? (jsImplementation = await jsImplementations[
                                      platform
                                  ]())
        ...
        Capacitor = /* @__PURE__ */ initCapacitorGlobal(
            typeof globalThis !== "undefined"
                ? globalThis
                : typeof self !== "undefined"
                ? self
        ...
        normalizeHttpHeaders = (headers = {}) => {
            ...
            const loweredKeys = Object.keys(headers).map((k) =>
                k.toLocaleLowerCase()
            );
...
// node_modules/.pnpm/@codetrix-studio+capacitor-google-auth@3.3.6(@capacitor+core@5.6.0)/node_modules/@codetrix-studio/capacitor-google-auth/dist/esm/web.js
var web_exports = {};
        ...
        GoogleAuthWeb = class extends WebPlugin {
            ...
            initialize(
                ...
                this.options = {
                    clientId,
                    grantOfflineAccess:
                        (_b = _options.grantOfflineAccess) !== null && _b !== void 0
                            ? _b
                            : false,
            ...
            async signIn() {
                return new Promise(async (resolve, reject) => {
                    ...
                    try {
                        let serverAuthCode;
                        const needsOfflineAccess =
                            (_a = this.options.grantOfflineAccess) !== null &&
                            _a !== void 0
                                ? _a
                                : false;
...
// node_modules/.pnpm/@codetrix-studio+capacitor-google-auth@3.3.6(@capacitor+core@5.6.0)/node_modules/@codetrix-studio/capacitor-google-auth/dist/esm/index.js
init_dist();
var GoogleAuth = registerPlugin("GoogleAuth", {
    web: () =>
        Promise.resolve()
            .then(() => (init_web(), web_exports))
            .then((m) => new m.GoogleAuthWeb()),
});

// app/index.ts
var PROD_URL = "https://bagel03.github.io/drivegame2024/builds/prod";
var LOCAL_URL = "http://localhost:5500/dist";
var DIST_URL = "./dist"; //localStorage.getItem("dev-env") ? LOCAL_URL : PROD_URL;
